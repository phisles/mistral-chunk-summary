...
def rephrase_as_single_transcript(summary):
    prompt_suffix = "Rephrase the following summary to sound like it describes a single interview or incident in a single paragraph. Do not add an adjectives or subjective descriptions of the interview. Begin and end the summary with only the factual:"
